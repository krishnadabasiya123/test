...
import 'package:test/ui/animatedScreens/pizzOrderAnimation/colors.dart';
import 'package:test/ui/animatedScreens/pizzOrderAnimation/models/pizza.dart';
import 'package:test/ui/animatedScreens/pizzOrderAnimation/utils/uiUtils.dart';
import 'package:test/utils/convertNumber.dart';
...
class _PizzaDetailsScreenState extends State<PizzaDetailsScreen>
  ...
  late double defaultPizzaPanScale = UiUtils.getPizzaPanScale(
    widget.dheight,
  ); //default size is M differnce between s m l is 0.25 respectively 0.1
  ...
  late double defaultToppingsDyPercentage = UiUtils.getToppingsDy(
    widget.dheight,
  );
  ...
  late final Animation<double> _initialLeafBaseAnimation =
      Tween<double>(begin: 0.0, end: 0.65).animate(
        CurvedAnimation(
          parent: _initialLoadAnimationController,
  ...
  //pan angle animation
  late Animation<double> angleAnimation = angleTween.animate(
    CurvedAnimation(parent: changePizzaController, curve: Sprung.underDamped),
  );
  ...
  late AlignmentTween pizzaSizeAlignmentTween = AlignmentTween(
    begin: Alignment.center,
    end: Alignment.center,
  );
  //background circle alignment animation
  late Animation<Alignment> pizzaSizeAlignmentAnimation =
      pizzaSizeAlignmentTween.animate(
        CurvedAnimation(parent: pizzaSizeController, curve: Sprung.underDamped),
      );
  //pizzPanScale tween for s,m and l size pizza
  late Tween<double> pizzaPanScaleTween = Tween<double>(
    begin: defaultPizzaPanScale,
    end: defaultPizzaPanScale,
  );
  //pizzaPanScale animation
  late Animation<double> pizzaPanScaleAnimation = pizzaPanScaleTween.animate(
    CurvedAnimation(parent: pizzaSizeController, curve: Sprung.underDamped),
  );

  //to change pizza scale
  late Tween<double> pizzaPanShadowTween = Tween<double>(
    begin: defaultPizzzaPanShadow,
    end: defaultPizzzaPanShadow,
  );
  //pizzaScale animation

  late Animation<double> pizzaPanShadowAnimation = pizzaPanShadowTween.animate(
    CurvedAnimation(parent: pizzaSizeController, curve: Sprung.underDamped),
  );
  ...
  late Animation<double> pizzaSizeAnimation = pizzaScaleTween.animate(
    CurvedAnimation(parent: pizzaSizeController, curve: Sprung.underDamped),
  );
  ...
  //leaf height
  late Tween<double> leafHeightTween = Tween<double>(
    begin: defaultLeafHeight,
    end: defaultLeafHeight,
  );
  late Animation<double> leafHeightAnimation = leafHeightTween.animate(
    CurvedAnimation(parent: pizzaSizeController, curve: Sprung.underDamped),
  );

  //leaf dy in reverse direction
  late Tween<double> leafDyTween = Tween<double>(
    begin: defaultLeafDy,
    end: defaultLeafDy,
  );
  late Animation<double> leafDyAnimation = leafDyTween.animate(
    CurvedAnimation(parent: pizzaSizeController, curve: Sprung.underDamped),
  );

  //leaf angle animation
  late Animation<double> leafAngleAnimation = leafAngleTween.animate(
    CurvedAnimation(parent: changePizzaController, curve: Sprung.underDamped),
  );
  ...
  late Animation<int> pizzaPriceAnimation = pizzaPriceTween.animate(
    CurvedAnimation(parent: changePizzaPriceController, curve: Curves.easeIn),
  );
  ...
  late Animation<double> pizzaTitleBaseAnimation =
      Tween<double>(begin: 0.0, end: 1.0).animate(
        CurvedAnimation(
          parent: changePizzaTitleController,
          curve: Curves.easeInOut,
        ),
      );

  late PageController pizzaPageController = PageController(
  ...
  late Tween<double> toppingsScaleTween = Tween<double>(
    begin: defaultToppingsScale,
    end: defaultToppingsScale,
  );
  ...
  late Tween<double> toppingsDyTween = Tween<double>(
    begin: defaultToppingsDyPercentage,
    end: defaultToppingsDyPercentage,
  );
  ...
  late Tween<double> toppingsDxTween = Tween<double>(
    begin: defaultToppingsDx,
    end: defaultToppingsDx,
  );
  ...
  late Animation<Alignment> addToCartPizzaAnimation =
      AlignmentTween(
  ...
  //
  late PageController toppingsPageController = PageController(
    initialPage: 3,
  ...
  void initToppingsAnimation() {
    for (var _ in toppings) {
      toppingsAnimationController.add(
        AnimationController(
          vsync: this,
  ...
  void changePizzaTitleAndPrice(int index) {
    if (currentIndex > index) {
      ...
      pizzaPriceTween.end = _determineNextPizzaPrice(
        pizzas[currentIndex - 1].price,
      );
    } else {
      angleTween.begin = currentIndex * 1.0 * -panAngle;
      angleTween.end = (currentIndex + 1) * 1.0 * -panAngle;
                  ...
                  return Container(
                    ...
                    transform: Matrix4.identity()
                      ..setEntry(
                        1,
                        3,
                        -widget.dheight * toppingsDyAnimation.value,
                      ) //0.04,0.04,0.045
                      ..setEntry(
                        0,
                        3,
                        toppingsDxAnimation.value,
                      ) //-1.5,-2.5,-3.5
              ...
              child: Container(
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (pageOffset <= 0.0) {
                      begin =
                          (currentToppingPage.floor() - index) *
                          translatePageToppingDy;
                      end =
                          (currentToppingPage.ceil() - index) *
                          translatePageToppingDy;
                      ...
                      begin =
                          (index - currentToppingPage.ceil()) *
                          translatePageToppingDy;
                      end =
                          (index - currentToppingPage.floor()) *
                          translatePageToppingDy;
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        if (addedToppings.contains(toppings[index])) {
                          ...
                          if (addedToppings.length < 3) {
                            ...
                            toppingsAnimationController[index].forward(
                              from: 0.0,
                            );
                          }
                        }
                      ...
                      child: Opacity(
                        opacity: addedToppings.contains(toppings[index])
                            ? 0.5
                            : 1.0,
                        child: Container(
                          transformAlignment: Alignment.center,
                          transform: Matrix4.identity()
                            ..scale(scale) //1.5
                            ..setEntry(1, 3, dy),
                          child: Image.asset(toppings[index].image),
                        ),
                      ),
                    );
                  },
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      if (pizzaSizeAlignmentAnimation.value !=
                        ...
                        pizzaScaleTween.begin = pizzaScaleTween.end;
                        pizzaScaleTween.end = UiUtils.getPizzaScale(
                          widget.dheight,
                        );
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (pageOffset <= 0.0) {
                          ...
                          scale = ConvertNumber.inRange(
                            ...
                            maxValue: 1.0,
                            newMaxValue: 0.5,
                            newMinValue: pizzaSizeAnimation.value,
                          ); //scale of pizza
                        ...
                        return Hero(
                          ...
                          child: Opacity(
                            ...
                            child: Container(
                              ...
                              child: Image.asset(pizzas[index].image),
                            ),
                          ),
                        );
                      },
        ...
        child: Row(
          children: [
            ...
            FadeTransition(
              ...
              child: SlideTransition(
                position: _initialAppbarBaseAnimation.drive(
                  Tween<Offset>(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(pizzas[currentIndex].subTitle),
                      ],
                    ),
                  ),
                );
              ...
              Expanded(
                child: GestureDetector(
                  onTap: () {
                    ...
                    //add pizza to cart
                    addToCartAnimationController.forward(from: 0.0).then((
                      value,
                    ) {
